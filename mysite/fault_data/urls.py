...
#	url(r'^fault_cause/del/(?P<mode_id>\d+)/$', views.delcause),
	url(r'^fault_mode/modify/(?P<mode_id>\d+)/$', views.modifymode),
#	url(r'^fault_cause/modify/(?P<mode_id>\d+)/$', views.modifycause),
	url(r'^dfunction/(?P<function_id>\w+)/$', views.dfunction),
	url(r'^fault_mode/modify/(?P<mode_id>\d+)/(?P<attr>\w+)$', views.detailmodify),
	...
	url(r'^fault_mode/addattr/$', views.addmodeattr),
