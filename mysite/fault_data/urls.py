...
urlpatterns = patterns('',
	...
	url(r'^mc_relation/del/(?P<mode_id>\d+)/(?P<cause_id>\d+)/$', views.del_mc_relation),
	url(r'^mm_relation/del/(?P<mode_id1>\d+)/(?P<mode_id2>\d+)/$', views.del_mm_relation),
	...
	url(r'^fault_cause/addattr/$', views.add_cause_attr),
